...
full_traj = md.load('1000_samples/MutationConformationsBioEmu/out_native/samples.xtc', top='1000_samples/MutationConformationsBioEmu/out_native/topology.pdb')
